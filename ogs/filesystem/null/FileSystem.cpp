...
FileHandle_t CFileSystemNull::Open(const char *pFileName, const char *pOptions, const char *pathID = 0L)
{
...
const char *CFileSystemNull::FindFirst(const char *pWildCard, FileFindHandle_t *pHandle, const char *pathID = 0L)
{
...
FileHandle_t CFileSystemNull::OpenFromCacheForRead(const char *pFileName, const char *pOptions, const char *pathID = 0L)
{
