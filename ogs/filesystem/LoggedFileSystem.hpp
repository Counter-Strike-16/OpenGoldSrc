...
/// @file
/// @brief logged implementation of filesystem

#pragma once

#include "public/FileSystem.h"

class CLoggedFileSystem : public IFileSystem
{
public:
	CLoggedFileSystem(IFileSystem &apFileSystemImpl) : mpImpl(apFileSystemImpl){}
	~CLoggedFileSystem();
