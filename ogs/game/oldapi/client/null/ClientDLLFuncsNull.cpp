...
void ClientDLL_StudioEvent(const struct mstudioevent_s *event,
...
void ClientDLL_TxferLocalOverrides(entity_state_t *state,
                                   const clientdata_t *client){};

void ClientDLL_ProcessPlayerState(entity_state_t *dst,
                                  const entity_state_t *src){};

void ClientDLL_TxferPredictionData(entity_state_t *ps,
...
int ClientDLL_ConnectionlessPacket(const struct netadr_s *net_from,
                                   const char *args,
                                   char *buffer,
                                   int *size)
{
...
void ClientDLL_TempEntUpdate(
double frametime, double client_time, double cl_gravity, struct tempent_s **ppTempEntFree, struct tempent_s **ppTempEntActive, int (*Callback_AddVisibleEntity)(cl_entity_t *pEntity), void (*Callback_TempEntPlaySound)(struct tempent_s *pTemp, float damp)){};
...
int ClientDLL_GetStudioModelInterface(int version,
...
cldll_func_t gClientDLLFuncsNull = { ClientDLL_Initialize,
	                                 ClientDLL_Init,
	                                 ClientDLL_VidInit,
