// Null implementation for NEW_DLL_FUNCTIONS (this struct can be optionally
// present in gamedll)
...
NEW_DLL_FUNCTIONS gNewGameDLLFuncsNull = {
	GameDLL_OnFreeEntPrivateData, GameDLL_GameShutdown, GameDLL_ShouldCollide, GameDLL_CvarValue, GameDLL_CvarValue2
};