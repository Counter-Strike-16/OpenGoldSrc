...
void COptionsSubMultiplayer::InitCrosshairTypeList(CLabeledCommandComboBox *cb)
{
	...
	cb->AddItem("#GameUI_CrossHairType_0", "cl_crosshair_type 0");
	cb->AddItem("#GameUI_CrossHairType_1", "cl_crosshair_type 1");
	cb->AddItem("#GameUI_CrossHairType_2", "cl_crosshair_type 2");
	cb->AddItem("#GameUI_CrossHairType_3", "cl_crosshair_type 3");
	cb->AddItem("#GameUI_CrossHairType_4", "cl_crosshair_type 4");
