...
public:
	    ...
	    : BaseClass(NULL, "OptionsSubVideoGammaDlg")
	{
		...
		LoadControlSettingsFromScheme("OptionsSubVideoGammaDlg.res");
...
public:
	...
	virtual void OnResetData(void)
	{
		...
		m_pDetailTexture->SetSelected(engine->pfnGetCvarFloat("r_detailtextures") != 0);
		m_pWaterReflect->SetSelected(engine->pfnGetCvarFloat("gl_reflectwater") != 0);
		m_pWaitForVSync->SetSelected(engine->pfnGetCvarFloat("gl_vsync") != 0);
	}
    ...
    : PropertyPage(parent, NULL)
{
	...
	LoadControlSettingsFromScheme("OptionsSubVideo.res");
...
void COptionsSubVideo::OnPageShow(void)
{
}
...
void COptionsSubVideo::PerformLayout(void)
{
	BaseClass::PerformLayout();
}

void COptionsSubVideo::OnThink(void)
{
	BaseClass::OnThink();
...
public:
	    ...
	    : BaseClass(NULL, NULL)
	{
		...
		SetSize(500, 200);
		LoadControlSettingsFromScheme("OptionsSubVideoThirdPartyDlg.res");
		MoveToCenterOfScreen();
		SetSizeable(false);
		SetDeleteSelfOnClose(true);
	}
