...
#ifndef GAMEUI_SCRIPTOBJECT_H
#define GAMEUI_SCRIPTOBJECT_H
...
public:
	...
	bool ReadFromBuffer( char **pBuffer );
	virtual bool InitFromFile( char *pszFileName );
	void TransferCurrentValues();
...
{
public:
	using BaseClass = CDescription;

	CInfoDescription( CPanelListPanel *panel );

	bool InitFromFile( char *pszFileName ) override;
