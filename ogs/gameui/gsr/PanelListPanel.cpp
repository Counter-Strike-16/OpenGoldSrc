...
VScrollBarReversedButtons::VScrollBarReversedButtons( vgui2::Panel* parent, const char* panelName, bool vertical )
	: BaseClass( parent, panelName, vertical )
{
}
...
// Output : 
//-----------------------------------------------------------------------------
CPanelListPanel::CPanelListPanel( vgui2::Panel* parent, const char* panelName, bool inverseButtons )
...
// Purpose: 
//-----------------------------------------------------------------------------
int	CPanelListPanel::computeVPixelsNeeded()
{
	int pixels = 0;
	DATAITEM *item;
	Panel *panel;
