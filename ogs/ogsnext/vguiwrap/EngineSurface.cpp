/*
EngineSurface.cpp - main vgui layer
...
CEngineSurface::CEngineSurface(Panel *apEmbeddedPanel) : SurfaceBase(apEmbeddedPanel)
{
	_embeddedPanel = apEmbeddedPanel;
...
Panel *CEngineSurface::getEmbeddedPanel()
{
...
void CEngineSurface::setCursor(Cursor *apCursor)
{
	_currentCursor = apCursor;
	VGUI_CursorSelect(apCursor);
};
...
void CEngineSurface::popMakeCurrent(Panel *panel)
{
	...
	if(top > 0)
		SetupPaintState( _paintStack[top-1] );
};
