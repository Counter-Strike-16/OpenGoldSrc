...
// HLGameSpectatorListener.hpp - header of hl-compatible game spectator listener class

#ifndef MGT_HLGAMESPECTATORLISTENER_HPP
#define MGT_HLGAMESPECTATORLISTENER_HPP
...
#endif // MGT_HLGAMESPECTATORLISTENER_HPP