...
*
*	Copyright (C) 2015-2016 Sh1ft0x0EF
*
...
// HLGameDLL.hpp - header of hl-compatible format implementation of game dll to support HLSDK gamedlls

#ifndef MGT_HLGAMEDLL_HPP
#define MGT_HLGAMEDLL_HPP
