...
// HLGameSpectatorListener.cpp - source of hl-compatible game spectator listener class

#include "hlcompatgamedll/HLGameSpectatorListener.hpp"
#include "debug/Debug.hpp"

CHLGameSpectatorListener::CHLGameSpectatorListener(DLL_FUNCTIONS *apHLGameDLL)
{
	LogMsg("Constructing the hl-compatible game spectator listener component...");
...
{
	LogMsg("Destructing the hl-compatible game spectator listener component...");
};
