...
// HLCompatClientInput.hpp - header of hl-compatible client input class

#ifndef MGT_HLCOMPATCLIENTINPUT_HPP
#define MGT_HLCOMPATCLIENTINPUT_HPP
...
private:
	cdll_func_t *mpClientExports;
};

#endif // MGT_HLCOMPATCLIENTINPUT_HPP