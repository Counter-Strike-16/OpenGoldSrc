...
// HLPlayerMovement.hpp - header of hl-compatible player movement class

#ifndef MGT_HLPLAYERMOVEMENT_HPP
#define MGT_HLPLAYERMOVEMENT_HPP
...
#endif // MGT_HLPLAYERMOVEMENT_HPP