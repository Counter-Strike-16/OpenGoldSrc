...
#define DT_TIMEWINDOW_8 \
	BIT(5) // A floating point timestamp relative to server time
#define DT_TIMEWINDOW_BIG \
	BIT(6)                // A floating point timestamp relative to server time (with more
                          // precision and custom multiplier)
...
void DELTA_AddEncoder(char *name,
