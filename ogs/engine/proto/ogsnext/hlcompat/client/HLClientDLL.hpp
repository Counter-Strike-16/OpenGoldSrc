...
// HLCompatClientDLL.hpp - wrapper class around old hlsdk client interface header

#ifndef MGT_HLCOMPATCLIENTDLL_HPP
#define MGT_HLCOMPATCLIENTDLL_HPP
...
#endif // MGT_HLCOMPATCLIENTDLL_HPP