...
// HLClientHUD.hpp - header of hl-compatible client hud class

#ifndef MGT_HLCOMPATCLIENTHUD_HPP
#define HMGT_HLCOMPATCLIENTHUD_HPP
...
#endif // MGT_HLCOMPATCLIENTHUD_HPP