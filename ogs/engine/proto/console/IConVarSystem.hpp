...
public:
							...
							CConVar() { assert( typeid( this ) != typeid( idCVar ) ); }

							// Always use one of the following constructors.
							CConVar( const char *name, const char *value, int flags, const char *description,
...
protected:
	...
	CConVar *				internalVar;			// internal cvar
};
...
struct IConVarSystem : public IBaseInterface
{
	virtual void			Init() = 0;
...
extern IConVarSystem *cvarSystem;
