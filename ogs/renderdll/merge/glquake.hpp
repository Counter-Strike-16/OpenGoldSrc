...
const int TILE_SIZE = 128; // size of textures generated by R_GenTiledSurf

const int SKYSHIFT = 7;
const int SKYSIZE = (1 << SKYSHIFT);
const int SKYMASK = (SKYSIZE - 1);
...
extern int mirrortexturenum; // local texturenum, not gltexturenum
